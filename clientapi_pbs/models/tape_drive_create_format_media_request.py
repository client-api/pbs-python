...
class TapeDriveCreateFormatMediaRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["fast", "label-text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TapeDriveCreateFormatMediaRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TapeDriveCreateFormatMediaRequest from a dict"""
        if obj is None:
            return None
