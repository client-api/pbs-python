...
class AdminDatastoreCreateChangeOwnerRequest(BaseModel):
    """
    ...
    new_owner: Annotated[str, Field(min_length=3, strict=True, max_length=64)] = Field(description="Authentication ID", alias="new-owner")

    ns: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Namespace.")

    __properties: ClassVar[List[str]] = ["backup-id", "backup-type", "new-owner", "ns"]
    ...
    def new_owner_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not isinstance(value, str):
            value = str(value)
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDatastoreCreateChangeOwnerRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDatastoreCreateChangeOwnerRequest from a dict"""
        if obj is None:
            return None
