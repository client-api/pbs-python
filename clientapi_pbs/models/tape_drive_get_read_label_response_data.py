...
class TapeDriveGetReadLabelResponseData(BaseModel):
    """
    ...
    pool: Optional[StrictStr] = Field(default=None, description="MediaSet Pool")

    seq_nr: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="MediaSet media sequence number", alias="seq-nr")

    uuid: Annotated[str, Field(strict=True)] = Field(description="Media Uuid.")

    __properties: ClassVar[List[str]] = ["ctime", "encryption-key-fingerprint", "label-text", "media-set-ctime", "media-set-uuid", "pool", "seq-nr", "uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TapeDriveGetReadLabelResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TapeDriveGetReadLabelResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ctime": obj.get("ctime"),
            "encryption-key-fingerprint": obj.get("encryption-key-fingerprint"),
