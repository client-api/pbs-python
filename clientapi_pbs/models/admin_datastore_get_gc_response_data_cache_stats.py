...
class AdminDatastoreGetGcResponseDataCacheStats(BaseModel):
    """
    Garbage collection cache statistics
    """ # noqa: E501

    hits: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of atime update cache hits")

    misses: Annotated[int, Field(strict=True, ge=0)] = Field(description="Number of atime update cache misses")

    __properties: ClassVar[List[str]] = ["hits", "misses"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDatastoreGetGcResponseDataCacheStats from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDatastoreGetGcResponseDataCacheStats from a dict"""
        if obj is None:
            return None
