...
class ConfigVerifyGetConfigVerifyByIdResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigVerifyGetConfigVerifyByIdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigVerifyGetConfigVerifyByIdResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": ConfigVerifyGetVerifyResponseDataInner.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "total": obj.get("total"),
