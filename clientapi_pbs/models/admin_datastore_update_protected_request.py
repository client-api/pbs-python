...
class AdminDatastoreUpdateProtectedRequest(BaseModel):
    """
    ...
    protected: StrictBool = Field(description="Enable/disable protection.")

    __properties: ClassVar[List[str]] = ["backup-id", "backup-time", "backup-type", "ns", "protected"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDatastoreUpdateProtectedRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDatastoreUpdateProtectedRequest from a dict"""
        if obj is None:
            return None
