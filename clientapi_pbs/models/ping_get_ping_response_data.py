...
class PingGetPingResponseData(BaseModel):
    """
    PingGetPingResponseData
    """ # noqa: E501

    pong: StrictBool = Field(description="Always true")

    __properties: ClassVar[List[str]] = ["pong"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PingGetPingResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PingGetPingResponseData from a dict"""
        if obj is None:
            return None
