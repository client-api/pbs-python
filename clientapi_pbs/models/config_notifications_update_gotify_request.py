...
class ConfigNotificationsUpdateGotifyRequest(BaseModel):
    """
    ...
    delete: Optional[List[PbsConfigNotificationsInlineEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    server: Optional[StrictStr] = Field(default=None, description="Gotify Server URL.")

    token: Optional[StrictStr] = Field(default=None, description="Authentication token")

    __properties: ClassVar[List[str]] = ["comment", "delete", "digest", "disable", "server", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigNotificationsUpdateGotifyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigNotificationsUpdateGotifyRequest from a dict"""
        if obj is None:
            return None
