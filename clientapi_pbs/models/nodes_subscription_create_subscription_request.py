...
class NodesSubscriptionCreateSubscriptionRequest(BaseModel):
    """
    NodesSubscriptionCreateSubscriptionRequest
    """ # noqa: E501

    force: Optional[StrictBool] = Field(default=False, description="Always connect to server, even if information in cache is up to date.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesSubscriptionCreateSubscriptionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesSubscriptionCreateSubscriptionRequest from a dict"""
        if obj is None:
            return None
