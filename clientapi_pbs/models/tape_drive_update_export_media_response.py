...
class TapeDriveUpdateExportMediaResponse(BaseModel):
    """
    TapeDriveUpdateExportMediaResponse
    """ # noqa: E501

    data: Annotated[int, Field(strict=True, ge=1)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TapeDriveUpdateExportMediaResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TapeDriveUpdateExportMediaResponse from a dict"""
        if obj is None:
            return None
