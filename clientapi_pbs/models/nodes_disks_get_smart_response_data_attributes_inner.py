...
class NodesDisksGetSmartResponseDataAttributesInner(BaseModel):
    """
    NodesDisksGetSmartResponseDataAttributesInner
    """ # noqa: E501

    flags: Optional[StrictStr] = Field(default=None, description="ATA Flags")

    id: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="ATA Attribute ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NodesDisksGetSmartResponseDataAttributesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NodesDisksGetSmartResponseDataAttributesInner from a dict"""
        if obj is None:
            return None
