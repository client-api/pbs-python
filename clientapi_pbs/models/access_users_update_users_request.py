...
class AccessUsersUpdateUsersRequest(BaseModel):
    ...
    delete: Optional[List[PbsAccessUsersInlineEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    firstname: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=64)]] = Field(default=None, description="First name.")

    lastname: Optional[Annotated[str, Field(min_length=2, strict=True, max_length=64)]] = Field(default=None, description="Last name.")

    password: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]] = Field(default=None, description="This parameter is ignored, please use 'PUT /access/password' to change a user's password")
