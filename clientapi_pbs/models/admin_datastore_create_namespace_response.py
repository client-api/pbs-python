...
class AdminDatastoreCreateNamespaceResponse(BaseModel):
    """
    AdminDatastoreCreateNamespaceResponse
    """ # noqa: E501

    data: Annotated[str, Field(strict=True, max_length=256)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDatastoreCreateNamespaceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDatastoreCreateNamespaceResponse from a dict"""
        if obj is None:
            return None
