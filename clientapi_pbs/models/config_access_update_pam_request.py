...
class ConfigAccessUpdatePamRequest(BaseModel):
    """
    ...
    delete: Optional[List[PbsConfigAccessDeleteEnum]] = Field(default=None, description="List of properties to delete.")
    ...
    __properties: ClassVar[List[str]] = ["comment", "default", "delete", "digest"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigAccessUpdatePamRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigAccessUpdatePamRequest from a dict"""
        if obj is None:
            return None
