...
class ConfigNotificationsCreateGotifyRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["comment", "disable", "filter", "name", "origin", "server", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigNotificationsCreateGotifyRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigNotificationsCreateGotifyRequest from a dict"""
        if obj is None:
            return None
