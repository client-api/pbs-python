...
class BackupUpgradeCreateBlobRequest(BaseModel):
    """
    BackupUpgradeCreateBlobRequest
    """ # noqa: E501

    encoded_size: Annotated[int, Field(le=16777260, strict=True, ge=12)] = Field(description="Encoded blob size.", alias="encoded-size")

    file_name: Annotated[str, Field(strict=True)] = Field(description="Backup archive name.", alias="file-name")

    __properties: ClassVar[List[str]] = ["encoded-size", "file-name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupUpgradeCreateBlobRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupUpgradeCreateBlobRequest from a dict"""
        if obj is None:
            return None
