...
class AdminDatastoreUpdateNotesRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backup-id", "backup-time", "backup-type", "notes", "ns"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDatastoreUpdateNotesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDatastoreUpdateNotesRequest from a dict"""
        if obj is None:
            return None
