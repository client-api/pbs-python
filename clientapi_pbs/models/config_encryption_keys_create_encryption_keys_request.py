...
class ConfigEncryptionKeysCreateEncryptionKeysRequest(BaseModel):
    """
    ...
    key: Optional[StrictStr] = Field(default=None, description="Use provided key instead of creating new one.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigEncryptionKeysCreateEncryptionKeysRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigEncryptionKeysCreateEncryptionKeysRequest from a dict"""
        if obj is None:
            return None
