...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "PBSAuthCookie": APIKeyAuthSetting,
        "CSRFPreventionToken": APIKeyAuthSetting,
        "PBSApiToken": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = clientapi_pbs.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://localhost:8007/api2/json" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("clientapi_pbs")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'PBSAuthCookie' in self.api_key:
            auth['PBSAuthCookie'] = {
                'type': 'api_key',
                'in': 'cookie',
                'key': 'PBSAuthCookie',
        ...
        if 'PBSApiToken' in self.api_key:
            auth['PBSApiToken'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
